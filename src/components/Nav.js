...
import { setIsVisibale } from "../store/action";
    ...
    <section class="sticky top-0 z-20 px-3 py-3 bg-white shadow dark:text-gray-100 dark:bg-gray-900 lg:px-5 print:hidden">
      <nav class="relative">
        <div class="flex items-center justify-between">
          <div>
            <button
              onClick={() => dispatch(setIsVisibale())}
          ...
          <div class="justify-center hidden ">
            <div class=" xl:w-96">
              <div class="relative flex flex-wrap items-center w-full ">
                <input
                  type="search"
                  class="form-control relative flex-auto min-w-0 block w-72 px-3 py-1.5 text-base font-normal text-gray-700 bg-white  dark:text-gray-100 bg-clip-padding border border-solid border-gray-300 dark:border-gray-800 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white dark:bg-gray-800  focus:border-blue-600 focus:outline-none"
                  placeholder="Search"
                />
                <button
                  class="btn i px-6 py-2.5 bg-blue-600 dark:bg-blue-300 dark:hover:bg-blue-400  dark:text-gray-900 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out flex items-center"
                  type="button"
                  id="button-addon2"
                >
                  <svg
          ...
          <div class="flex items-center">
            ...
            <div class="relative mr-4 ">
              <span>
                <div class="absolute top-0 right-0 w-2 h-2 bg-red-400 rounded-full"></div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
            ...
            <div class="relative text-left lg:inline-block">
              <div class="lg:block">
              ...
              <div
                x-show="open"
                id="dropdown_profile"
                class="absolute right-0 w-48 mt-3 origin-top-right bg-white rounded shadow dark:bg-gray-800 dark:text-gray-100 "
              ></div>
            </div>
          </div>
        </div>
